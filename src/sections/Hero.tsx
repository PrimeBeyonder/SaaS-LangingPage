          ...
          <div className="container">
              <div className="md:flex items-center">
                  ...
                  <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
                      ...
                      <Image src={cylinder} alt="" width={220} height={220} className="hidden md:block -top-8 -left-32 md:absolute"/>
                      <Image src={noodleImage} alt="" width={220} height={220} className="hidden lg:block rotate-[30%] top-[524px] left-[448px] md:absolute"/>
                  </div>
              </div>
          </div>
      </section>
