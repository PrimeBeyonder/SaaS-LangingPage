  ...
  return (
    <section className=" bg-gradient-to-b from-[#ffff] to-[#D2DCFF] py-24 overflow-x-clip">
      <div className="container">
          ...
          <h2 className="text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent mt-5">A More Effective Way To Track Progess</h2>
        ...
        <Image src={pymarid} alt="Pymarid Image" className=" absolute -top-32 -right-36" height={262} width={262}/>
        <Image src={tubeImage} alt="Tube Image" className=" absolute bottom-24 -left-36" height={248} width={262}/>
        </div>
      </div>
    </section>
  );
